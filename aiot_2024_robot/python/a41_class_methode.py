...
def main():
    ...
    student_a = Student("A", 87, 88, 98, 98)
    student_b = Student("B", 92, 78, 76, 83)
    print(f"stduent_a == student_b: {student_a == student_b}")
    print(f"stduent_a 1= student_b: {student_a != student_b}")
