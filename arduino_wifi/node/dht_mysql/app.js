var fs = require('fs'); 	//굳이 없어됨 
var ejs = require('ejs');		//있어야
var http = require('http');		//잇
var mysql = require('mysql');	//잇
...
app.get('/',function(req,res) // htt:/localhost / 뒤에 아무것도 없을때  
{
